...
func (_m *IPool) Acquire(ctx context.Context) (*pgxpool.Conn, error) {
	ret := _m.Called(ctx)
...
func (_m *IPool) AcquireAllIdle(ctx context.Context) []*pgxpool.Conn {
	ret := _m.Called(ctx)
...
func (_m *IPool) AcquireFunc(ctx context.Context, f func(*pgxpool.Conn) error) error {
	ret := _m.Called(ctx, f)
...
func (_m *IPool) Config() *pgxpool.Config {
	ret := _m.Called()
...
func (_m *IPool) CopyFrom(ctx context.Context, tableName pgx.Identifier, columnNames []string, rowSrc pgx.CopyFromSource) (int64, error) {
...
func (_m *IPool) SendBatch(ctx context.Context, b *pgx.Batch) pgx.BatchResults {
	ret := _m.Called(ctx, b)
...
func (_m *IPool) Stat() *pgxpool.Stat {
	ret := _m.Called()
